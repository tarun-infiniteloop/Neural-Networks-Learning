...
%         computed in ex4.m
%
% add columb of 1's in X matrics
% columb of value 1's is already added in sigmoid function which is in
% predict.m

%substitute for y is z variable
%z = zeros(size(y,1),1);

%predict p vector m*1
%p = zeros(m,1);
%p = predict(Theta1,Theta2,X); 

%for k = 1:num_labels
% set y as vector in 1's ans 0's
% z = y;
